...
public class UserServiceImpUnitTest {
	...
	public void getAllUsersCredits() {
		...
		assertEquals(creditsList.get(0).getNotApprovedCredits(), service.getAllUsersCredits().get(0).getNotApprovedCredits());
		assertEquals(creditsList.get(1).getApprovedCredits(), service.getAllUsersCredits().get(1).getApprovedCredits());
		assertEquals(creditsList.get(1).getNotApprovedCredits(), service.getAllUsersCredits().get(1).getNotApprovedCredits());
		assertEquals(creditsList.get(2).getApprovedCredits(), service.getAllUsersCredits().get(2).getApprovedCredits());
		assertEquals(creditsList.get(2).getNotApprovedCredits(), service.getAllUsersCredits().get(2).getNotApprovedCredits());
	...
	public void getAllMenteeCreditsByTutorTest() {
		...
		lenient().when(userRepository.findAllByTutor(tutor)).thenReturn(list);		
		lenient().when(userActivityService.listAllActivitiesOfUser(email)).thenReturn(listOfUserActivity);
		assertEquals(creditsList.get(0).getApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(0).getApprovedCredits());
		assertEquals(creditsList.get(0).getNotApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(0).getNotApprovedCredits());
		assertEquals(creditsList.get(1).getApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(1).getApprovedCredits());
		assertEquals(creditsList.get(1).getNotApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(1).getNotApprovedCredits());
		assertEquals(creditsList.get(2).getApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(2).getApprovedCredits());
		assertEquals(creditsList.get(2).getNotApprovedCredits(), service.getAllMenteeCreditsByTutor(tutor).get(2).getNotApprovedCredits());
