...
public class UserActivityService {
	...
	public String insertNewUserActivity(Long idUser, Long idActivity, Boolean organizer) {
		...
		// If organizer field is true check if already an organizer have been set for
		// the activity
		if (organizer) {
	...
	public String deleteUserActivityByActivityId(AppUser appUser, Activity activity) {
		...
		Optional<UserActivity> userActivityOptional = userActivityRepository.findByUserAndActivityAndOrganizer(appUser,
				activity, false);
	...
	public Optional<UserActivity> getUserActivityByUserAndActivityAndOrganizer(String user, Long activityId,
			Boolean organizer) {

		Optional<AppUser> userOptional = userRepository.findByEmail(user);
		Optional<Activity> activityOptional = activityRepository.findById(activityId);
		return userActivityRepository.findByUserAndActivityAndOrganizer(userOptional.get(), activityOptional.get(),
				organizer);
	}
