...
public interface ActivityRepository extends JpaRepository<Activity, Long> {
	...
	// Return a list of activities, if they exist, by not the activity's title
	// specified, the state and the startDate
	List<Activity> findAllByStartDateGreaterThanAndStateAndActivityTypeNotIn(Date startDate, Boolean state,
			Collection<ActivityType> activityType);
