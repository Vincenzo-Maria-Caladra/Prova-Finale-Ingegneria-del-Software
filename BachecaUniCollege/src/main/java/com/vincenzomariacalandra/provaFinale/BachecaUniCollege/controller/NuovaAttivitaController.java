...
public class NuovaAttivitaController {
	...
	@Autowired
	public NuovaAttivitaController(ActivityService activityService, UserActivityService userActivityService,
			MultipartProcessingUtility multipartProcessing) {
	...
	public String addActivity(@Valid @ModelAttribute("activity") Activity activity,
			@RequestParam(name = "fileImage", required = false) MultipartFile multipartFile, Model model,
